...
public interface ICompanyOrchestrationService
{
    ...
    /// </summary>
    Task<SyncState> SyncCompaniesToKekaAsync(CancellationToken cancellationToken = default);
    ...
    /// Returns incremental sync state including newly created mappings and failed companies.
    /// </summary>
    Task<SyncState> SyncCompaniesIncrementalAsync(SyncState syncState, CancellationToken cancellationToken = default);
